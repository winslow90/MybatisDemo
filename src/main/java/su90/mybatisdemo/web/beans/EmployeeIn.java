...
@JsonPropertyOrder(value = {"id", "fname", "lname", "email", "phone", 
    "hiredate", "job_id","salary","comm","manager_id","department_id"})
public class EmployeeIn {
    ...
    public String toString() {
        return "EmployeeIn{" + ", fname=" + fname + ", lname=" + lname + ", email=" + email + ", phone=" + phone + ", hiredate=" + hiredate + ", job_id=" + job_id + ", salary=" + salary + ", comm=" + comm + ", manager_id=" + manager_id + ", department_id=" + department_id + '}';
    }
